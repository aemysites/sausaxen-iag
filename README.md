...
## Environments
- Preview: https://main--sausaxen-iag--aemysites.aem.page/
- Live: https://main--sausaxen-iag--aemysites.aem.live/
- Block Library: https://main--sausaxen-iag--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `sausaxen-iag` directory in your favorite IDE and start coding :)
